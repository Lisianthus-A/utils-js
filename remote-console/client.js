...
(function () {
    ...
    function resolveArgs(value) {
        ...
        function resolveObj(obj, stringify) {
            ...
            for (var k in obj) {
                if (obj.hasOwnProperty(k)) {
                    o[k] = getResolveValue(obj[k], false);
                }
            }

            if (stringify) {
                var _o = JSON.stringify(o);
                resolvedValue.push(_o);
                return _o;
            } else {
                return o;
            }
        ...
        function getResolveValue(value, stringify) {
            var type = Object.prototype.toString.call(value);
            switch (type) {
                case "[object Array]":
                    return resolveArray(value, stringify);
                case "[object Object]":
                    return resolveObj(value, stringify);
        ...
        return getResolveValue(value, true);
    }
